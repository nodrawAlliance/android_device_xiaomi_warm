...
BOARD_PREBUILT_BOOTIMAGE := device/qcom/pitti/boot.img
...
AB_OTA_UPDATER := true
TARGET_RECOVERY_FSTAB := device/xiaomi/warm/recovery.fstab
else
TARGET_RECOVERY_FSTAB := device/xiaomi/warm/recovery_non_AB.fstab
...
include device/qcom/wlan/pitti/BoardConfigWlan.mk
endif
else
include device/qcom/wlan/pitti/BoardConfigWlan.mk
endif
