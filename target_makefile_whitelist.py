...
VENDOR_FOREACH_WHITELIST = {
    "device/qcom/common/utils.mk",
    "device/qcom/pitti/pitti.mk",
    "device/qcom/wlan/pitti/BoardConfigWlan.mk",
    "device/qcom/wlan/pitti/wlan.mk",
    "vendor/qcom/opensource/audio-hal/primary-hal/configs/pitti/pitti.mk",
...
VENDOR_SOONG_WHITELIST = {
    "device/qcom/pitti/BoardConfig.mk",
